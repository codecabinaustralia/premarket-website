    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-8 w-full">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          className="flex-1 flex items-center justify-center gap-3 bg-black text-white py-4 rounded-xl shadow-lg hover:shadow-xl transition-shadow"
        >
      ...
      <p className="text-sm text-slate-500">
        ...
        <a href="mailto:knockknock@premarket.homes" className="text-orange-600 hover:underline">
          Contact Support
        </a>
      </p>
    </>
