  ...
  return (
    <div className="bg-white text-slate-900">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 -mt-6 sm:-mt-10">
        <BreakoutStats
          stats={[
            { eyebrow: 'PHI metrics', value: 8, label: 'Live indicators tracked per suburb, updated continuously.' },
            { eyebrow: 'Real reports', value: 1280, label: 'Live and recently-completed vendor reports across Australia.' },
            { eyebrow: 'Setup time', value: 2, suffix: ' min', label: 'From sign-up to your first campaign live and collecting data.' },
          ]}
        />
      </section>
      ...
      <section className="bg-slate-50 border-y border-slate-200/70 py-24 sm:py-32">
        <PullQuote
          quote="It's like a Bloomberg terminal for residential property — except the data is generated by the buyers themselves."
