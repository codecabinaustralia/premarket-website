...
export default function Hero() {
 ...
 <img src="/assets/icon3.png" alt="Extend Campaign" className="mx-auto mb-4 w-16 h-16 mt-4 rounded" />
              ...
              <div className=" my-3 ">
                <h2 className="leading-none text-xl inter bg-clip-text text-transparent" style={{
                  ...
                  Hire a verified, top-rated agent directly through the Premarket app.
                </h2>
              </div>
