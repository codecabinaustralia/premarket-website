  ...
  const steps = [
    {
      ...
      description: 'Before your appraisal — or during the meeting itself. Takes 2 minutes.',
      icon: (
    ...
    },
    {
      ...
      description: 'Instead of asking for thousands in marketing spend upfront, you offer a premarket campaign to test the waters first. Watch their resistance disappear.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
