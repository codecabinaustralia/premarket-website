...
export default function HowItWorksClient() {
  ...
  return (
    <div className="relative bg-white min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-gray-700 to-gray-900  py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Test the market before selling your property—save money or make money with a free premarket campaign
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl interBold text-gray-900 mb-4">
              {activeRole === 'seller' ? 'Three Simple Steps to Test the Market' : 'Your Path to Off-Market Property Success'}
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="relative group">
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-2xl interBold text-gray-900 mb-4">
                  {activeRole === 'seller' ? 'List Your Property Free on Premarket' : 'Browse Off-Market Properties'}
                </h3>
            ...
            <div className="relative group">
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-2xl interBold text-gray-900 mb-4">
                  {activeRole === 'seller' ? 'Receive Real Buyer Feedback and Price Opinions' : 'Share Your Price Opinion'}
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  {activeRole === 'seller'
                    ? 'Buyers share their price opinions and express genuine interest. Watch as real market data comes in from active buyers across Australia.'
            ...
            <div className="relative group">
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-2xl interBold text-gray-900 mb-4">
                  {activeRole === 'seller' ? 'Get Your Comprehensive Market Report' : 'Act Fast on Properties'}
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  {activeRole === 'seller'
                    ? 'Get your comprehensive market report with real buyer feedback. Decide whether to go to market with confidence or stay put—entirely up to you.'
      ...
      {/* Detailed Stages - continue with rest of component... */}
